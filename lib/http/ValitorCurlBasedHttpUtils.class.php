...
class ValitorCurlBasedHttpUtils implements IValitorHttpUtils
{
    ...
    public function requestURL(ValitorHttpRequest $request)
    {
        ...
        $httpResponse = new ValitorHttpResponse();
        ...
        if($httpResponse->getErrorMessage() == 'connect() timed out!'
            ...
            $httpResponse->setConnectionResult(ValitorHttpResponse::CONNECTION_TIMEOUT);
        }
            ...
            $httpResponse->setConnectionResult(ValitorHttpResponse::CONNECTION_REFUSED);
        }
        else if(preg_match('/Operation timed out/i', $httpResponse->getErrorMessage())) {
            $httpResponse->setConnectionResult(ValitorHttpResponse::CONNECTION_READ_TIMEOUT);
        }
        else
        {
            $httpResponse->setConnectionResult(ValitorHttpResponse::CONNECTION_OKAY);
        }
